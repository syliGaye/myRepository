...
/**
 * classe d'une table à quatre (8) tuples
 */
class Repository_8
{
    /*
    ...
    */
    ...
    public function __construct($bdd, $table, $var1, $var2, $var3, $var4, $var5, $var6, $var7, $var8)
    {
        $this->inserer = $bdd->prepare('INSERT INTO '.$table.'('.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.') VALUES (:'.$var1.', :'.$var2.', :'.$var3.', :'.$var4.', :'.$var5.', :'.$var6.', :'.$var7.', :'.$var8.')') ;
        $this->selectAll = $bdd->prepare('SELECT DISTINCT '.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.' FROM '.$table.' ORDER BY '.$var1) ;
        $this->modifier = $bdd->prepare('UPDATE '.$table.' SET '.$var1.' = :'.$var1.', '.$var2.' = :'.$var2.', '.$var3.' = :'.$var3.', '.$var4.' = :'.$var4.', '.$var5.' = :'.$var5.', '.$var6.' = :'.$var6.', '.$var7.' = :'.$var7.', '.$var8.' = :'.$var8.' WHERE '.$var1.' = :'.$var1) ;
        ...
        $this->selectById = $bdd->prepare('SELECT DISTINCT '.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.' FROM '.$table.' WHERE '.$var1.' = :'.$var1.' ORDER BY '.$var1) ;
        $this->selectByValue1 = $bdd->prepare('SELECT DISTINCT '.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.' FROM '.$table.' WHERE '.$var2.' = :'.$var2.'') ;
        $this->selectByValue2 = $bdd->prepare('SELECT DISTINCT '.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.' FROM '.$table.' WHERE '.$var3.' = :'.$var3.'') ;
        $this->selectByValue3 = $bdd->prepare('SELECT DISTINCT '.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.' FROM '.$table.' WHERE '.$var4.' = :'.$var4.'') ;
        $this->selectByValue4 = $bdd->prepare('SELECT DISTINCT '.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.' FROM '.$table.' WHERE '.$var5.' = :'.$var5.'') ;
        $this->selectByValue5 = $bdd->prepare('SELECT DISTINCT '.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.' FROM '.$table.' WHERE '.$var6.' = :'.$var6.'') ;
        $this->selectByValue6 = $bdd->prepare('SELECT DISTINCT '.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.' FROM '.$table.' WHERE '.$var7.' = :'.$var7.'') ;
        $this->selectByValue7 = $bdd->prepare('SELECT DISTINCT '.$var1.', '.$var2.', '.$var3.', '.$var4.', '.$var5.', '.$var6.', '.$var7.', '.$var8.' FROM '.$table.' WHERE '.$var8.' = :'.$var8.'') ;
    }

    public function save($var1, $var2, $var3, $var4, $var5, $var6, $var7, $var8, $val1, $val2, $val3, $val4, $val5, $val6, $val7, $val8){
    ...
    public function merge($var1, $var2, $var3, $var4, $var5, $var6, $var7, $var8, $val1, $val2, $val3, $val4, $val5, $val6, $val7, $val8){
