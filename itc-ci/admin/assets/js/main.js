...
$(function() {
  ...
  ITC.global = {
    ...
    init: function() {
      ITC.global.deviceSize();
      ITC.global.layout();
      ITC.global.animsition();
    },
    ...
    layout: function() {
      var defaultHeaderScheme = 'scheme-light',
          ...
          defaultAppClasses = 'scheme-light cyan-scheme-color header-fixed aside-fixed rightbar-hidden';
  ...
  ITC.navbar = {
    ...
    init: function() {
      ITC.navbar.menu();
      ITC.navbar.ripple();
      ITC.navbar.removeRipple();
      ITC.navbar.collapse();
      ITC.navbar.offcanvas();
    },
  ...
  ITC.extra = {
    ...
    init: function() {
      ITC.extra.sparklineChart();
      ITC.extra.slimScroll();
      ITC.extra.daterangePicker();
      ITC.extra.easypiechart();
      ITC.extra.chosen();
      ITC.extra.toggleClass();
      ITC.extra.colorpicker();
      ITC.extra.touchspin();
      ITC.extra.datepicker();
      ITC.extra.animateProgress();
      ITC.extra.counter();
      ITC.extra.popover();
      ITC.extra.tooltip();
      ITC.extra.splash();
  ...
  ITC.isMobile = {
    ...
    any: function() {
      return (ITC.isMobile.Android() || ITC.isMobile.BlackBerry() || ITC.isMobile.iOS() || ITC.isMobile.Opera() || ITC.isMobile.Windows());
    }
  };
  ...
  ITC.documentOnResize = {

		init: function(){

      var t = setTimeout( function(){

        ITC.documentOnReady.setSidebar();
        ITC.navbar.removeRipple();
  ...
  ITC.documentOnReady = {
      ...
      ITC.global.init();
			ITC.header.init();
      ITC.navbar.init();
      ITC.documentOnReady.windowscroll();
      ITC.tiles.init();
      ITC.extra.init();
      ITC.documentOnReady.setSidebar();
		},
  ...
  // initializing
  //!!!!!!!!!!!!!
  $(document).ready( ITC.documentOnReady.init );
  $window.load( ITC.documentOnLoad.init );
  $window.on( 'resize', ITC.documentOnResize.init );
